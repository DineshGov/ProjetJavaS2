...
/**
 * 
 * Cette classe est la capacite AntiEmeute. Elle permet aux combattants d'attaquer et surtout de se defendre.
 ...
 * 
 */
public class AntiEmeute extends Bouclier implements Capacite{

		
		private static String nom="AntiEmeute";
		private float effAtt;
		private float pbaAtt;
		private float effDef;
		private float pbaDef;
		private static float pro = 50.0f;
		...
		public AntiEmeute(int dexterite, int force) {
		...
		public String toString() {
			return AntiEmeute.nom
					...
					+"\n	Protection: " + AntiEmeute.pro 
					+"\n	Maniabilité: " + AntiEmeute.man;
		}
